...
async def metadata_from_text_ai(filename: str, first_page_text: str, subject: str, grade: str) -> ExamMetadata:
    fallback = metadata_from_text(filename, first_page_text, subject, grade)
    system = (

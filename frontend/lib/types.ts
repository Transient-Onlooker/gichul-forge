...
export interface CurriculumUnit { id: string; level: "major" | "middle" | "minor"; title: string; subjectArea: "math" | "science"; keywords: string[]; tags: string[]; children: CurriculumUnit[]; }
...
export interface IssueRecord { id: string; nodeId: string; title: string; detail: string; severity: "info" | "warning" | "critical"; autoFixable: boolean; resolved: boolean; resolution?: string; createdAt: string; }
